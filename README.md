...
- **Kazi Amin** - Frontend Mobile Developer
- **Andre Hebra** - Frontend Mobile Developer
- **Muzamil Shamsi** - Frontend Web Developer (also Backend)
- **Aisha Fathalla** - Frontend Web Developer
- **Hashim Alkhateeb** - Frontend Web & Mobile Developer (also Backend API)
- **Connor Rick** - Database, API, Backend Lead Developer
- **Brittany Clark** - Frontend Web Developer
