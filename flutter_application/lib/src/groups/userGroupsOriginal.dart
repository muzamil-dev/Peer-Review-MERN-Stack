...
class _UserGroupState extends State<UserGroup> {
  ...
  Future<void> getGroupsData(BuildContext context, String workspaceId) async {
    final url =
        Uri.parse('http://ratemypeer.site/api//workspaces/$workspaceId/groups');
    try {
...
class _GroupCardState extends State<GroupCard> {
  ...
  Future<dynamic> getUser(String userID) async {
    final url = Uri.parse('http://ratemypeer.site/api//users/$userID');
    try {
      final response = await http.get(url);
  ...
  Future<void> joinGroup(BuildContext context, String groupID) async {
    final url = Uri.parse('http://ratemypeer.site/api//groups/join');
  ...
  Future<void> leaveGroup(BuildContext context) async {
    final url = Uri.parse('http://ratemypeer.site/api//groups/leave');
