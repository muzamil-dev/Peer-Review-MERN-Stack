        ...
        <section id="about" className="section">
          <div className="container">
            <div className="about-content">
              ...
              <p>
                Rate My Peer is an essential tool in group-based learning
                environments, allowing instructors to gain valuable insights
                into the dynamics within student teams. Through regular
                questionnaires, students can provide feedback on their peers,
                helping to identify strengths, areas for improvement, and
                potential issues early on. This process not only promotes
                accountability and transparency but also fosters a culture of
                continuous improvement and collaboration within the group.
              </p>
              <p>
                This project was developed during one of our own group-based
                courses. As we delved deeper into the development process, we
                became increasingly aware of the critical role that effective
                peer feedback plays in the success of a team. The more we
                collaborated, the more we recognized the importance of strong
                team values—values that encourage open communication, mutual
                respect, and shared responsibility. We believe that when a team
                embodies these principles, they are more likely to overcome
                challenges and achieve success together.
              </p>
            </div>
          </div>
        </section>
